...
- Adept at **architectures and system design**
...
**Frontend & Runtime:** React, Node.js
...
| Role | Company | Focus |
|------|---------|-------|
| AI Solutions Engineer | Nymbl | MCP agent platform, RAG knowledge bases, agentic workflows |
| Full Stack Developer - AI | Full Flex Marketing | Agentic chatbots, CRM automation, 90-95% scheduling reduction |
| AI Engineer | RR Portfolios | Multimodal RAG for financial analysis, 10hr to 20min review cycles |
| Data Scientist | Caeros | Investor recommendation system (700K+ records), email marketing AI |
| GA - Data Science Developer | George Washington University | LLM grading platform, quiz generation with fine-tuned Mistral-7B |
